...
const Popup: FC<PropsWithChildren<IPopup>> = ({
  ...
  return (
    ...
    >
      <div className="bg-slate-500 min-w-[40vw] min-h-[40vh] m-10 max-w-[90vw] max-h-[90vh] overflow-y-scroll">
        <span className="flex bg-black justify-center items-center h-11 fixed w-full">
