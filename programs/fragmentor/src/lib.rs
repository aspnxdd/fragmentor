...
use anchor_spl::token::{
    initialize_account, mint_to, InitializeAccount, Mint, MintTo, Token, TokenAccount, Transfer,
};
use mpl_token_metadata::instruction::{create_master_edition_v3, create_metadata_accounts_v3};
mod constants;
use anchor_spl::token;

use constants::ANCHOR_DISC;
...
pub fn mint_nft(
    ...
    let symbol = std::string::ToString::to_string("fragment");
    invoke(
